...
$sql = "SELECT * FROM `regprofile` WHERE `Exempt` = 'YES' OR `Exempt` = 'Approved' ORDER BY `ProfileID` ASC;";
//echo "<br>sql: $sql<br>";
...
<h1>Current and Pending Exemption Listing</h1>
<script>
$(function() {
  $("#filter").focus();
  $("#xMsg").fadeOut(5000);
...
<table class=table>
<tr id=head><th>ProfileID</th><th title="Indicates if an exemption of fees was requested. Marked &apos;appoved&apos; only by Festival Registrar using this utility.">ExemptReq?</th><th>FIrstName</th><th>LastName</th><th>Address</th><th>City</th><th>ST</th><th>Zip</th><th>PhoneNbr</th></tr>
<?=$tr?>
</table>
=== END LIST ===<br>
</body>
